...
fileprivate extension ACFloatingTextfield {
    ...
    func addBottomLine(){
        ...
        let leadingConstraint = NSLayoutConstraint.init(item: bottomLineView!, attribute: .leading, relatedBy: .equal, toItem: self, attribute: .leading, multiplier: 1, constant: 5.0)
        ...
        bottomLineViewHeight = NSLayoutConstraint.init(item: bottomLineView!, attribute: .height, relatedBy: .equal, toItem: nil, attribute: .notAnAttribute, multiplier: 1, constant: 0.5)
    ...
    func addFloatingLabel(){
        ...
        labelPlaceholder?.font = Utility.SetRagular(12)
    ...
    func addErrorPlaceholderLabel() -> Void {
        ...
        labelErrorPlaceholder?.font = Utility.SetRagular(12)
